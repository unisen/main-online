<aside class="main-sidebar fixed offcanvas shadow" data-toggle='offcanvas'>
    <section class="sidebar">
        <div class="w-80px mt-3 mb-3 ml-3">
            <img src="../../includes/template/assets/img/basic/logo.png" alt="">
        </div>
        <div class="relative">
            ...
            <div class="user-panel p-3 light mb-2">
                <div>
                    <div class="float-left image">
                        <img class="user_avatar" src="/paper-panel/app/includes/template/assets/img/dummy/u2.png" alt="User Image">
                    </div>
                    <div class= "float-left info">
                        <h6 class="font-weight-light mt-2 mb-1"><?php echo $_SESSION['name']; ?></h6>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#"> <i class="icon icon-dialpad blue-text  s-18"></i>
                    <span>Extra</span>
                    <i class="icon icon-angle-left s-18 pull-right"></i>
                </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview no-b">
                <a href="../../login/logout.php"> 
                    <i class="icon icon-sign-out pink-text s-18"></i>
                    <span>Sair</span>                    
                </a>
            </li>
        </ul>
