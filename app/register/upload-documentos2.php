...
?>
<form class="form-signin" action="" method="POST" enctype="multipart/form-data" id="myform">
    ...
    <div id="upload-form">
        <fieldset>
            ...
            <?php
            if ($dados_associado['SEXO'] != 'masculino') {
            ...
            <div class="">
                <div class="btn-register">
                    ...
                    <button class="btn btn-warning pull-right" type="button" onclick="document.getElementById('tela-cadastro2').click()"><i class="icon-keyboard_arrow_left"> </i>Voltar</button>
                    <button class="btn btn-large btn-success" type="button" value="Submit" id="btnSubmit">Upload</button>
                    <button class="btn btn-primary nextBtn pull-right" type="button">Próximo <i class="icon-keyboard_arrow_right"> </i></button>
                </div>
            </div>
        </fieldset>
    </div>
