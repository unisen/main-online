                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="external-events">
                                            <div class="external-event bg-green p-2 my-2 r-3 text-white">Lunch</div>
                                            <div class="external-event bg-yellow p-2 my-2 r-3 text-white">Go home</div>
                                            <div class="external-event purple p-2 my-2 r-3 text-white">Do homework</div>
                                            <div class="external-event bg-light-blue p-2 my-2 r-3 text-white">Work on UI design</div>
                                            <div class="external-event bg-red p-2 my-2 r-3 text-white">Sleep tight</div>
                                        </div>
                                    </div>
                                    <div class="card-body b-t pt-2 pb-2">
                                        <div class="checkbox">
                                    ...
                                    <div class="card-footer white">
                                        <div class="btn-group" style="width: 100%; margin-bottom: 10px;">
                                            ...
                                            <ul class="fc-color-picker list-inline-item" id="color-chooser">
                                                <li class="list-inline-item"><a class="text-aqua" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-blue" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-light-blue" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-teal" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-yellow" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-orange" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-green" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-lime" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-red" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-purple" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-fuchsia" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-muted" href="#"><i class="icon-square s-24"></i></a></li>
                                                <li class="list-inline-item"><a class="text-navy" href="#"><i class="icon-square s-24"></i></a></li>
                                            </ul>
                                        </div>
