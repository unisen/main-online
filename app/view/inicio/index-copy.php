...
$path .= '\config\autenticaUsuario.php';
echo $path;
include_once($path); 
 */

$path =  $_SERVER['DOCUMENT_ROOT'];
$path .= '/unisen-gestao/app/config/functions/autenticaUsuario.php';
//echo $path;
include_once($path);
?>
...
$path =  $_SERVER['DOCUMENT_ROOT'];
$path .= '/unisen-gestao/app/includes/UI/header.php';
//echo $path;
include_once($path);
...
<body>
  <div class=" container-scroller">
    ...
    $path =  $_SERVER['DOCUMENT_ROOT'];
    $path .= '/unisen-gestao/app/includes/UI/navbar.php';
    //echo $path;
    include_once($path);
    ...
    <div class="container-fluid">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <?php 
          ...
          $path =  $_SERVER['DOCUMENT_ROOT'];
          $path .= '/unisen-gestao/app/includes/UI/sidebar.php';
          //echo $path;
          include_once($path);
        ...
        <?php 
         ...
         /*  $path = dirname(__DIR__);
          ...
          $path =  $_SERVER['DOCUMENT_ROOT'];
          $path .= '/unisen-gestao/app/includes/UI/footer.php';
          //echo $path;
          include_once($path);
