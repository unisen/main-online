    ...
    <div id="app">
        ...
        <div class="has-sidebar-left">
            ...
            <div class="page has-sidebar-left height-full">
                ...
                <link rel="stylesheet" href="form/fonts/material-design-iconic-font/css/material-design-iconic-font.css">

                <!-- DATE-PICKER -->
                <link rel="stylesheet" href="form/vendor/date-picker/css/datepicker.min.css">
                ...
                <div class="container-fluid my-3">
                    ...
                    <!-- TEMPLATE FORM STEPS -->
                    <?php require_once './form/cadastrantes.php'; ?>
                </div>
            </div>
            <!-- Right Sidebar -->
       ...
       <!--  <script src="form/js/jquery-3.3.1.min.js"></script> -->
        ...
        <!-- JQUERY STEP -->
        <script src="form/js/jquery.steps.js"></script>

        <!-- DATE-PICKER -->
        <script src="form/vendor/date-picker/js/datepicker.js"></script>
        <script src="form/vendor/date-picker/js/datepicker.en.js"></script>
