            ...
            <div class="row no-gutters">
                                    ...
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="../../includes/template/assets/img/dummy/u1.png" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="../../includes/template/assets/img/dummy/u6.png" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                                    <strong>Alexander Pierce</strong>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="../../includes/template/assets/img/dummy/u2.png" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                                    <strong>Alexander Pierce</strong>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="../../includes/template/assets/img/dummy/u3.png" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                                    <strong>Alexander Pierce</strong>
                                ...
                                <li class="my-1">
                                    <div class="card no-b p-3">
                                        <div class="">
                                            ...
                                            <div class="image mr-3  float-left">
                                                <img class="w-40px" src="../../includes/template/assets/img/dummy/u4.png" alt="User Image">
                                            </div>
                                            <div>
                                                <div>
                                                    <strong>Alexander Pierce</strong>
                ...
                <div class="col-md-9 col-sm-12 light">
                   ...
                   <div class="card m-3 r-0 b-0 shadow">
                       <div class="card-header white"><h4>Add New Contact</h4>Add New Contact details</div>
                       <div class="card-body">
                           <div class="stepper sw-main sw-theme-circles"
                               ...
                               <div>
                                       ...
                                       <form>
                                           <div class="form-row">
                                               <div class="form-group col-md-6">
                                                   ...
                                                   <input class="form-control form-control-lg" id="inputEmail4" placeholder="Email User Email" type="email">
                                               </div>
                                               <div class="form-group col-md-6">
                                                   <label for="name" class="col-form-label">Name</label>
                                                   <input class="form-control form-control-lg" id="name" placeholder="Enter User Name" type="text">
                                               </div>
                                           </div>
                                           <div class="form-group">
                                               <label for="inputAddress" class="col-form-label">Address</label>
                                               <input class="form-control form-control-lg" id="inputAddress" placeholder="1234 Main St" type="text">
                                           </div>
                                           <div class="form-group">
                                               <label for="inputAddress2" class="col-form-label">Address 2</label>
                                               <input class="form-control form-control-lg" id="inputAddress2" placeholder="Apartment, studio, or floor" type="text">
                                           </div>
                                           <div class="form-row">
                                               <div class="form-group col-md-6">
                                   ...
                                   <div id="step-2y" class="card-body text-center p-5">
                                       ...
                                       <a href="#step-3y" class="btn btn-primary mb-3 btn-lg">Go To Next Step</a>
                                   </div>
                                   <div id="step-3y" class="card-body text-center p-5">
                                       <h3 class="my-3">
                                           Step 3
                                       </h3>
                                       <a href="#step-4y" class="btn btn-primary mb-3 btn-lg">Go To Next Step</a>
                                   </div>
                                   <div id="step-4y" class="card-body text-center p-5">
                                       <h3 class="my-3">
                                           Step 4
                                       </h3>
                                       <a href="#step-1y" class="btn btn-primary mb-3 btn-lg">Go To Next Step</a>
                                   </div>
                               </div>
                           </div>
