...
$formData[] = $nome = legal_input($_POST['username_newusuario']);

$formData[] = $password = password_hash(legal_input($_POST['password_newcliente']), PASSWORD_BCRYPT);

$formData[] = $tipopessoa = legal_input($_POST['tipo_usuario_newcliente']);

$formData[] = $username = legal_input($_POST['nome_novo_cliente']);
...
if ($resposta != "") {
    //Registra o Log
    $acao = "Cadastro do cliente $username. Id: $resposta";
