                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <p id='msg'></p>
                                    <button title='Adicionar Novo Cliente' type='button' class='btn btn-success copiar'
                                        id="abreform_novocliente" onclick="openNav2();">
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="even dpedido" data-id="<?php echo $row->id; ?>">
                                                ...
                                                <td class="dpedidoitem">
                                                    <?php echo date('d/m/Y', strtotime($row->registro)); ?> </td>
                                                ...
                                                <i class='fas fa-edit'></i></button> -->
                                                    <button title="Excluir" type="button" id="btnExcluir"
