...
<div id="myNovoCliente" class="sidenav">
    ...
    <div class="ui-dialog-titlebar"><span class="ui_titulo">Adicionar Novo Usuário</span><button title='Fechar Janela' type='button' class='btn closebtn' id="x_editar_novo_cliente" onclick="closeNav2()">
            <i class='fas fa-times'></i><span class='btn-resp'> Fechar</span></button>
    </div>

    <form action="" id="adicionar_novo_cliente" name="adicionar_novo_cliente" method="POST" class="form-horizontal editar_novo_cliente" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col-md-3 situacao-label">
                    <div class="form-group">
                        ...
                        <input type="text" name="username_newusuario" id="username_newusuario" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="col-md-3 situacao-label">
                    <div class="form-group">
                        ...
                        <input type="password" name="password_newcliente" id="password_newcliente" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="col-md-2 situacao-label">
                    <div class="form-group">
                        ...
                        <select name="tipo_usuario_newcliente" id="tipo_usuario_newcliente" class="form-control">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nome_novo_cliente" id="nome_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="fantasia_novo_cliente" id="fantasia_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        ?>
                        <input type="date" name="registro_novo_cliente" id="registro_novo_cliente" class="form-control" value="<?php echo $user_registro; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="telefone_novo_cliente" id="telefone_novo_cliente" class="all_phones form-control" value="">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="inputName">Tipo Pessoa</label>
                        <select name="tipo_pessoa_newcliente" id="tipo_pessoa_newcliente" class="tipo_pessoa_cliente form-control">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" name="cnpj_novo_cliente" id="cnpj_novo_cliente" class="cnpj form-control" value="" required>
                        <input type="text" name="cpf_novo_cliente" id="cpf_novo_cliente" class="cpf form-control" value="" style="display:none;">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="inputName">ID/RG</label>
                        <input type="text" name="idrg_novo_cliente" id="idrg_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-group">
                        <label for="cep_novo_cliente" class="label-item-form">CEP</label>
                        <input type="text" id="cep_novo_cliente" name="cep_novo_cliente" class="cep form-control" size="10" maxlength="9" value="">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="cidade_novo_cliente" id="cidade_novo_cliente" class="form-control" value="">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="endereco_novo_cliente" id="endereco_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="inputName">Bairro</label>
                        <input type="text" name="bairro_novo_cliente" id="bairro_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="numero_novo_cliente" id="numero_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                <div class="col-md-10">
                    <div class="form-group">
                        <label for="inputName">Complemento</label>
                        <input type="text" name="complemento_novo_cliente" id="complemento_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="celular_novo_cliente" id="celular_novo_cliente" class="all_phones form-control" value="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputName">Website</label>
                        <input type="text" name="website_novo_cliente" id="website_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="email" name="emailnfe_novo_cliente" id="emailnfe_novo_cliente" class="form-control" value="">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
                        <label for="inputName">Contatos</label>
                        <input type="text" name="contatos_novo_cliente" id="contatos_novo_cliente" class="form-control" value="">
                    </div>
                </div>
...
<script>
    $('.tipo_pessoa_cliente').change(function() {
        ...
        if (opx == '1') {
            ...
            $("#cnpj_novo_cliente").prop('required', true);
            $('#cnpjpessoa').show();
            $('#cnpj_novo_cliente').val("");
            $('#cpf_novo_cliente').hide();
            $('#cpf_novo_cliente').prop('required', false);
            $('#cpfpessoa').hide();
        }
        if (opx == '2') {
            $('#cnpj_novo_cliente').hide();
            $("#cnpj_novo_cliente").prop('required', false);
            $('#cnpjpessoa').hide();
            $('#cpf_novo_cliente').val("");
            $('#cpf_novo_cliente').show();
            $("#cpf_novo_cliente").prop('required', true);
            $('#cpfpessoa').show();
...
<script>
    ...
    function openNav2() {
        ...
        document.getElementById("username_newusuario").value = "";
        document.getElementById("password_newcliente").value = "";
