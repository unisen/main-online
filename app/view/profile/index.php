...
require_once '../../DAO/controllers/UsuarioDAO.php';
...
<body class="light">
    ...
    <div id="app">
        ...
        $params = "WHERE id = $id_usuario"; // . $id_usuario;
         
        $UsuarioDAO = new UsuarioDAO();

        $usuario = $UsuarioDAO->selectUsuario($params);
        $_SESSION['dados_user_login']  = $usuario[0];

        //print_r( $_SESSION['dados_user_login']);
        //print_r($usuarios);
                    ...
                    <div class="container-fluid text-white">
                            ...
                            <div class="col">
                                <div class="pb-3">
                                    <div class="image mr-3  float-left">
                                        <img class="user_avatar no-b no-p" src="<?php echo $_SESSION['path_userimages'] . $_SESSION['userlogin']['user_image']; ?>" alt="User Image">
                                    </div>
                                    <div>
                                        <h6 class="p-t-10"><?php echo $_SESSION['name']; ?></h6>
                                        <?php echo $_SESSION['userlogin']['email']; ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <ul class="nav nav-material nav-material-white responsive-tab" id="v-pills-tab" role="tablist">
                                <li>
                                    <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home"><i class="icon icon-home2"></i>Meu Perfil</a>
                                </li>
                                <li>
                                    <a class="nav-link" id="v-pills-payments-tab" data-toggle="pill" href="#v-pills-payments" role="tab" aria-controls="v-pills-payments" aria-selected="false"><i class="icon icon-money-1"></i>Pagamentos</a>
                                </li>
                                <li>
                                    <a class="nav-link" id="v-pills-timeline-tab" data-toggle="pill" href="#v-pills-timeline" role="tab" aria-controls="v-pills-timeline" aria-selected="false"><i class="icon icon-cog"></i>Linha do Tempo</a>
                                </li>
                                <li>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card ">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item"><i class="icon icon-phone text-primary"></i><strong class="s-12">Telefone</strong> <span class="float-right s-12"><?php echo $_SESSION['userlogin']['telefone']; ?></span></li>
                                                <li class="list-group-item"><i class="icon icon-mobile text-primary"></i><strong class="s-12">Celular</strong> <span class="float-right s-12"><?php echo $_SESSION['userlogin']['celular']; ?></span></li>
                                                <li class="list-group-item"><i class="icon icon-mail text-success"></i><strong class="s-12">Email</strong> <span class="float-right s-12"><?php echo $_SESSION['userlogin']['email']; ?></span></li>
                                                <li class="list-group-item"><i class="icon icon-address-card-o text-warning"></i><strong class="s-12">Endereço</strong> <span class="float-right s-12"><?php echo $_SESSION['userlogin']['cidade'] . " - " . $_SESSION['userlogin']['estado']; ?></span></li>
                                                <li class="list-group-item"><i class="icon icon-web text-danger"></i> <strong class="s-12">Website</strong> <span class="float-right s-12"><?php echo $_SESSION['userlogin']['website']; ?></span></li>
                                            </ul>
                                        </div>
