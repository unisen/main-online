                                ...
                                <div class="pb-3">
                                    <div class="image mr-3  float-left">
                                        <img class="user_avatar no-b no-p"
                                            src="<?php echo $_SESSION['path_userimages'] . $_SESSION['userlogin']['user_image']; ?>"
                                            alt="User Image">
                                    </div>
                                    <div>
                                        ...
                                        <div class="card ">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item"><i
                                                        class="icon icon-phone text-primary"></i><strong
                                                        class="s-12">Telefone</strong> <span
                                                        class="float-right s-12"><?php echo $_SESSION['userlogin']['telefone']; ?></span>
                                                </li>
                                                <li class="list-group-item"><i
                                                        class="icon icon-mobile text-primary"></i><strong
                                                        class="s-12">Celular</strong> <span
                                                        class="float-right s-12"><?php echo $_SESSION['userlogin']['celular']; ?></span>
                                                </li>
                                                <li class="list-group-item"><i
                                                        class="icon icon-mail text-success"></i><strong
                                                        class="s-12">Email</strong> <span
                                                        class="float-right s-12"><?php echo $_SESSION['userlogin']['email']; ?></span>
                                                </li>
                                                <li class="list-group-item"><i
                                                        class="icon icon-address-card-o text-warning"></i><strong
                                                        class="s-12">Endereço</strong> <span
                                                        class="float-right s-12"><?php echo $_SESSION['userlogin']['cidade'] . " - " . $_SESSION['userlogin']['estado']; ?></span>
                                                </li>
                                                <li class="list-group-item"><i class="icon icon-web text-danger"></i>
                                                    <strong class="s-12">Website</strong> <span
                                                        class="float-right s-12"><?php echo $_SESSION['userlogin']['website']; ?></span>
                                                </li>
                                            </ul>
                                        </div>
