...
<?php
$userdados = $_SESSION['dados_user_login'];
//echo $userdados->nome;
?>
...
<form action="" id="update_cliente" name="update_cliente" method="POST" class="form-horizontal editar_cliente" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4 situacao-label">
                ...
                <div class="col-md-3 situacao-label">
                    <div class="form-group">
                        ...
                        <input type="text" name="username_usuario" id="username_usuario" class="form-control" value="<?php if(isset($userdados->username)) echo $userdados->username; ?>">
                    </div>
                </div>
                <div class="col-md-3 situacao-label">
                ...
                <div class="col-md-2 situacao-label">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nome_cliente" id="nome_cliente" class="form-control" value="<?php if(isset($userdados->nome)) echo $userdados->nome; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="fantasia_cliente" id="fantasia_cliente" class="form-control" value="<?php if(isset($userdados->fantasia)) echo $userdados->fantasia; ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" name="email_cliente" id="email_cliente" class="form-control" value="<?php if(isset($userdados->email)) echo $userdados->email; ?>" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="telefone_cliente" id="telefone_cliente" class="all_phones form-control" value="<?php if(isset($userdados->telefone)) echo $userdados->telefone; ?>">
                    </div>
                </div>
                <?php
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" name="cnpj_cliente" id="cnpj_cliente" class="cnpj form-control" value="
                        <? if (strlen($user_cnpj) == 18) echo $user_cnpj; ?>" style="<? echo $mostra1; ?>">
                        <input type="text" name="cpf_cliente" id="cpf_cliente" class="cpf form-control" value="<? if (strlen($user_cnpj) == 14) echo $user_cnpj; ?>" style="<? echo $mostra2; ?>">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="idrg_cliente" id="idrg_cliente" class="form-control" value="<?php if(isset($userdados->idrg)) echo $userdados->idrg; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" id="cep_cliente" name="cep_cliente" class="cep form-control" size="10" maxlength="9" value="<? echo $user_cep; ?>">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" name="cidade_cliente" id="cidade_cliente" class="form-control" value="<?php if(isset($userdados->cidade)) echo $userdados->cidade; ?>">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" name="endereco_cliente" id="endereco_cliente" class="form-control" value="<?php if(isset($userdados->endereco)) echo $userdados->endereco; ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="inputName">Bairro</label>
                        <input type="text" name="bairro_cliente" id="bairro_cliente" class="form-control" value="<?php if(isset($userdados->bairro)) echo $userdados->bairro; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="numero_cliente" id="numero_cliente" class="form-control" value="<?php if(isset($userdados->numero)) echo $userdados->numero; ?>">
                    </div>
                </div>
                <div class="col-md-10">
                    <div class="form-group">
                        <label for="inputName">Complemento</label>
                        <input type="text" name="complemento_cliente" id="complemento_cliente" class="form-control" value="<?php if(isset($userdados->complemento)) echo $userdados->complemento; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="celular_cliente" id="celular_cliente" class="all_phones form-control" value="<?php if(isset($userdados->celular)) echo $userdados->celular; ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="inputName">Website</label>
                        <input type="text" name="website_cliente" id="website_cliente" class="form-control" value="<?php if(isset($userdados->website)) echo $userdados->website; ?>">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="inputName">Fax</label>
                        <input type="text" name="fax_cliente" id="fax_cliente" class="all_phones form-control" value="<?php if(isset($userdados->fax)) echo $userdados->fax; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="email" name="emailnfe_cliente" id="emailnfe_cliente" class="form-control" value="<?php if(isset($userdados->emailnfe)) echo $userdados->emailnfe; ?>">
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="form-group">
                        <label for="inputName">Contatos</label>
                        <input type="text" name="contatos_cliente" id="contatos_cliente" class="form-control" value="<?php if(isset($userdados->contatos)) echo $userdados->contatos; ?>">
                    </div>
                </div>
                ...
                <div class="col-md-7">
                    <div class="form-group">
                        ...
                        <textarea name="obs_cliente" id="obs_cliente" class="form-control"><?php if(isset($userdados->obs)) echo $userdados->obs; ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                       ...
                       <!--  <input type="file" class="form-control" name="imageToUpload" id="imageToUpload" required /> -->
                        ...
                        <input type="hidden" id="user_image" name="user_image" value="<?php if(isset($userdados->user_image)) echo $userdados->user_image; ?>">
