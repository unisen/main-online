        ...
        <div class="has-sidebar-left">
            ...
            <div class="page has-sidebar-left height-full">
                    ...
                    <div class="container-fluid text-white">
                        ...
                        <div class="row">
                            <ul class="nav nav-material nav-material-white">
                                <li><a class="nav-link active" href="#">Page 1</a></li>
                ...
                <div class="container-fluid my-3">
                    ...
                    <?php
                    $pdocrud = new PDOCrud();
                    //$pdocrud->formDisplayInPopup($buttonContent = "add", $headerContent = "inserir");
                    $pdocrud->buttonHide($buttonname="cancel");
                    echo $pdocrud->dbTable("tbl_tomador")->render();

                    $pdocrud->dbTable("tbl_tomador")->render("insertform");
