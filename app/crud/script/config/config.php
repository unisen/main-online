...
if($_SERVER['HTTP_HOST'] == 'localhost' or strpos($_SERVER['HTTP_HOST'],"192.168") !== false) {
    ...
    $config["hostname"] =  "localhost";
    //Set the database name
    $config["database"] = "chefre17_dbunisen";
    //Set the username for database access
    $config["username"] = "chefre17_unisen2107";
    //Set the pwd for the database user
    $config["password"] = "LgBkCfTv7DEP";
    //Set the database type to be used. Available values are "mysql", "pgsql", "sqlite" and "sqlserver".
    $config["dbtype"] = "mysql";
...
$config["recordsPerPageDropdown"] = false;
...
$config["delbtn"] = true;
// NO CLIQUE EDITANDO A TABELA. 
//ROLA A TELA opa .show inline edit button (false = hide)
// Faz o edit cell funcionar
$config["inlineEditbtn"] = false;
//show clone row (copy row) button (false = hide)
$config["clonebtn"] = false;
//show action buttons (true = show)
$config["actionbtn"] = false;
