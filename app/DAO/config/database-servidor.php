...
abstract class database{
    ...
    private static $port     = "2083";
    private static $user     = "chefre17_unisen2107";
    private static $password = "LgBkCfTv7DEP";
    private static $db       = "chefre17_dbunisen";
    ...
    public function updateDB($sql,$params=null){
        ...
        catch(PDOException $erro)
        {
            ...
            $rs = array('codigo' => '0', 'mensagem' => ' Erro ao deletar os serviços. Tente novamente [1]. ::$erro'); 
            $this->disconnect();
            return $rs; 
