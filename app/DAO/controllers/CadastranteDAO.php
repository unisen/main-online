...
class CadastranteDAO extends database
{
  ...
  {
    $sql = "DELETE FROM tbl_cadastrantes WHERE ID = :id";
    return parent::deleteDB($sql, $data);
  }
  
  public function deleteCadastranteCadastro($data)
  {
    $sql = "DELETE FROM tbl_cadastrantes WHERE ID = :id";
    return parent::deleteDB($sql, $data);
  }
  ...
  public function selectCadastrante($params = null)
  {
    ...
    $sql = "SELECT * FROM tbl_cadastrantes $params";
