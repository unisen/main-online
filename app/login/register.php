                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown custom-dropdown user user-menu ">
                                <a href="#" class="nav-link" data-toggle="dropdown">
                                    <img src="../includes/template/assets/img/dummy/u8.png" class="user-image" alt="User Image">
                    ...
                    <div class="container">
                        <div class="col-xl-8 mx-lg-auto p-t-b-80">
                            <header class="text-center">
                                ...
                                <p>Join Our wonderful community and let others help you without a single penny
                                </p>
                                <img class="p-t-b-50" src="../includes/template/assets/img/icon/icon-join.png" alt="">
                            </header>
                            <form>
                                <div class="row">
                                    <div class="col-lg-6">
